...
@ActiveProfiles("test")
public class ItemController_Update_Test {
    ...
    public void update_jsonPath() {
        ...
        webTestClient
                .put()
                .uri(VERSION + GET_ENDPOINT + ID_PATH,itemTest.getId())
    ...
    public void update_jsonPath_notfound() {
        webTestClient
                .put()
                .uri(VERSION + GET_ENDPOINT + ID_PATH,Faker.instance()
                                                           .random()
                                                           .hex())
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
    ...
    public void update_RestAssuredWebTestClient() {
        ...
        RestAssuredWebTestClient
                ...
                .when()
                .put(VERSION + GET_ENDPOINT + ID_PATH,itemTest.getId())
